...
class Agent(object):
    ...
    def __init__(self, bzrc):
        ...
        self.enemy_repulsive_constant = 2
        self.enemy_tangential_constant = 0

        self.obstacle_repulsive_constant = 50
        self.obstacle_tangential_constant = 10

        self.obstacles = []
        self.create_obstacles(self.bzrc.get_obstacles())
    ...
    def move_to_position(self, bot, target_x, target_y):
        ...
        command = Command(bot.index, .5, 2 * relative_angle, False)
        self.commands.append(command)
